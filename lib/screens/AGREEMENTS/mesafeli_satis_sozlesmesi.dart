...
class SalesContractScreen extends StatefulWidget {
  ...
  const SalesContractScreen({
    Key? key,
    this.agreementAssetPath = 'assets/agreements/mesafeli_satis_sozlesmesi.txt',
    this.customTitle,
    this.customText,
  }) : super(key: key);

  @override
  State<SalesContractScreen> createState() => _SalesContractScreenState();
}

class _SalesContractScreenState extends State<SalesContractScreen> {
