...
class RegistrationAgreementScreen extends StatefulWidget {
  ...
  const RegistrationAgreementScreen({
    Key? key,
    this.agreementAssetPath = 'assets/agreements/membership_agreement.txt',
    this.customTitle,
    this.customText,
  }) : super(key: key);

  @override
  State<RegistrationAgreementScreen> createState() => _RegistrationAgreementScreenState();
}

class _RegistrationAgreementScreenState extends State<RegistrationAgreementScreen> {
