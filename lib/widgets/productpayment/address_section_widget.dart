...
void _showSubregionPicker(
    BuildContext context, ProductPaymentProvider provider, String selectedMainRegion) {
  final l10n = AppLocalizations.of(context);
  final bool isLight = Theme.of(context).brightness == Brightness.light;
  final buttonTextColor = isLight ? Colors.black : Colors.white;
  ...
  Widget build(BuildContext context) {
    ...
    return Container(
      ...
      child: Column(
        children: [
          InkWell(
            onTap: provider.toggleAddressExpansion,
            ...
            child: Padding(
              ...
              child: Row(
                children: [
                  ...
                  AnimatedRotation(
                    turns: provider.isAddressExpanded ? 0.5 : 0,
          ...
          AnimatedSize(
            ...
            child: Visibility(
              visible: provider.isAddressExpanded,
              maintainState: true,
                                ...
                                return Container(
                                  ...
                                  child: ListTile(
                                    ...
                                    onTap: () {
                                      ...
                                      final latLng = _getLatLngFromLocationData(locationData);
                                      if (latLng != null) {
                                      ...
                                      if (address['addressLine1'] != null) {
                                        provider.addressLine1Controller.text = address['addressLine1'];
                                      }
                                      if (address['addressLine2'] != null) {
                                        provider.addressLine2Controller.text = address['addressLine2'] ?? '';
                                      }
                                      if (address['region'] != null) {
                                        provider.setRegion(address['region']);
                                      }
                                      if (address['phoneNumber'] != null) {
                                        provider.phoneNumberController.text = address['phoneNumber'];
                                      }
                                    },
