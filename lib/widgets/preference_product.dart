...
class PreferenceProduct extends StatefulWidget {
  const PreferenceProduct({Key? key}) : super(key: key);

  static void clearCache() {
    _PreferenceProductState.clearCache();
  }

  @override
  State<PreferenceProduct> createState() => _PreferenceProductState();
}

class _PreferenceProductState extends State<PreferenceProduct> {
  ...
  Widget build(BuildContext context) {
    ...
    // Tablet-specific vertical margin to prevent overlap
    final double verticalMargin = isTablet
        ? (isLandscape ? 16.0 : 12.0)  // Tablets: more margin
        : 8.0;                          // Mobile: unchanged
